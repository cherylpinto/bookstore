          ...
          <ul class="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <HiOutlineCloudUpload className="h-6 w-6 text-gray-600 hover:text-gray-900" />
                <span class="flex-1 ms-3 whitespace-nowrap">Upload Book</span>
            ...
            <li>
              <a
                ...
                class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <ImBooks className="h-6 w-6 text-gray-600 hover:text-gray-900" />
